module.exports = (sequelize, dataTypes) => {
  ...
  Catalogo_material.associate = function (models) {
    Catalogo_material.belongsTo(models.Catalogo_unidad_medida, {
      as: "Catalogo_unidad_medida", // Usa el mismo alias definido en el modelo de unidad de medida
      foreignKey: "unidadMedida", // Usa el mismo campo que establece la relación
    });
  };
